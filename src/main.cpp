...
const string strMessageMagic = "MultCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MultCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("04d1246ace98ba47587806cad6a8979b9014475ba6656147db445d59c86fc84b33855595aff9e60b56f7bfe1b6176a7ea1532ed9fdae2f9d57ccbb4aef36e6ca6c");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MultCoin  13 de março de 2019";
        CTransaction txNew;
        txNew.nTime = 1552596136;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1552596136;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1076877 : 1076877;
        ...
        assert(block.hashMerkleRoot == uint256("0x3eb11c97b474a5575734807b0a6a8995b1574667cbf378c234ff7abbc69df078"));
...
unsigned char pchMessageStart[4] = { 0x02, 0x2f, 0x69, 0x46 };
